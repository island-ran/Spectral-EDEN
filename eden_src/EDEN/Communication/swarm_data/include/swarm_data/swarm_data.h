...
public:
    ...
    inline void SetTraj(Trajectory4<5> &traj, const double &s_t);
    ...
    /* trajectory */
    vector<Trajectory4<5>> trajs_;  
    vector<pair<Eigen::Vector3d, Eigen::Vector3d>> traj_bbxs_;  
...
inline void SwarmDataManager::SetTraj(Trajectory4<5> &traj, const double &s_t){
    flags_ |= 2;
