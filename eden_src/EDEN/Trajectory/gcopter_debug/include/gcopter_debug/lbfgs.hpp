...
namespace lbfgs
{
                                        ...
                                        const lbfgs_parameter_t &param)
    {
        ...
        while (true)
        {
            ...
            // std::cout<<"brackt:"<<brackt<<std::endl;

            f = cd.proc_evaluate(cd.instance, x, g);
            // std::cout<<"g.dot(s):"<<g.dot(s)<<std::endl;
            // std::cout<<"dstest:"<<dstest<<std::endl;
            // std::cout<<"f:"<<f<<std::endl;
            // std::cout<<"finit:"<<finit<<std::endl;
            // std::cout<<"finit + stp * dgtest:"<<finit + stp * dgtest<<std::endl;
            // std::cout<<"armijo:"<<(f <= finit + stp * dgtest)<<std::endl;
            // std::cout<<"Wolfe:"<<(g.dot(s) >= dstest)<<std::endl;
