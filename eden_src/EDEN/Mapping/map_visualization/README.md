# Map Visualization
This bag provides the function for global map visualization(block_map_lite only maintains local voxels). However, it can not delete points since it uses kd-tree. So it is not suggested to be used in dynamic environments.
